  ...
  >
    <transition-group name="toast" tag="div" class="flex flex-col gap-3">
      <div
        ...
        :key="notification.id"
        class="pointer-events-auto animate-slideIn"
        :class="{
      ...
      >
        <div class="rounded-lg px-4 py-3 shadow-lg flex items-center gap-3">
          <svg
          ...
          <button
            ...
            class="ml-auto flex-shrink-0 hover:opacity-70 transition"
          >
